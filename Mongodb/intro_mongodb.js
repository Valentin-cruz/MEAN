...
db.students.insert({name:"Valentin", home_state:"Texas", lucky_number:77, birthday:{month:1, day:27, year:1992}})
db.students.insert({name:"John", home_state:"California", lucky_number:22, birthday:{month:5, day:22, year:1995}})
db.students.insert({name:"Mark", home_state:"New York", lucky_number:68, birthday:{month:2, day:11, year:1985}})
db.students.insert({name:"Desi", home_state:"Washington", lucky_number:42, birthday:{month:12, day:4, year:1987}})
db.students.insert({name:"Glenn", home_state:"Arizona", lucky_number:13, birthday:{month:5, day:15, year:1995}})
...
db.students.update({name:"Valentin"},{$push:{interests:"games"}})
db.students.update({name:"John"},{$push:{interests:"dancing"}})
db.students.update({name:"Mark"},{$push:{interests:"music"}})
db.students.update({name:"Desi"},{$push:{interests:"surfing"}})
db.students.update({name:"Glenn"},{$push:{interests:"cars"}})
